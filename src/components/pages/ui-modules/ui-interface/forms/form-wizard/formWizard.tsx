                      ...
                      <ul className="nav nav-pills nav-justified form-wizard-header mb-3">
                        <li className="nav-item">
                          <Link
                            ...
                            data-bs-toggle="tab"
                            data-toggle="tab"
                            className={`nav-link rounded-0 py-2 ${currentStep === 1 ? "active" : ""
                              }`}
                          >
                        ...
                        <li className="nav-item">
                          <Link
                            ...
                            data-bs-toggle="tab"
                            data-toggle="tab"
                            className={`nav-link rounded-0 py-2 ${currentStep === 2 ? "active" : ""
                              }`}
                          >
                        ...
                        <li className="nav-item">
                          <Link
                            ...
                            data-bs-toggle="tab"
                            data-toggle="tab"
                            className={`nav-link rounded-0 py-2 ${currentStep === 3 ? "active" : ""
                              }`}
                          >
                      ...
                      <ul className="nav nav-pills nav-justified form-wizard-header mb-3">
                        <li className="nav-item">
                          <Link
                            ...
                            data-bs-toggle="tab"
                            data-toggle="tab"
                            className={`nav-link rounded-0 py-2 ${currentStep2 === 1 ? "active" : ""
                              }`}
                          >
                            <i className="bi bi-person-circle fs-18 align-middle me-1" />
                            <span className="d-none d-sm-inline">Account</span>
                        ...
                        <li className="nav-item">
                          <Link
                            ...
                            data-bs-toggle="tab"
                            data-toggle="tab"
                            className={`nav-link rounded-0 py-2 ${currentStep2 === 2 ? "active" : ""
                              }`}
                          >
                            <i className="bi bi-emoji-smile fs-18 align-middle me-1" />
                            <span className="d-none d-sm-inline">Profile</span>
                        ...
                        <li className="nav-item">
                          <Link
                            ...
                            data-bs-toggle="tab"
                            data-toggle="tab"
                            className={`nav-link rounded-0 py-2 ${currentStep2 === 3 ? "active" : ""
                              }`}
                          >
                            <i className="bi bi-check2-circle fs-18 align-middle me-1" />
                            <span className="d-none d-sm-inline">Finish</span>
                      ...
                      <ul className="nav nav-pills nav-justified form-wizard-header mb-3">
                        ...
                        >
                          <Link
                            ...
                            data-bs-toggle="tab"
                            data-toggle="tab"
                            className={`nav-link rounded-0 py-2 ${currentStep3 === 1 ? "active" : ""
                              }`}
                          >
                            <i className="bi bi-person-circle fs-18 align-middle me-1" />
                            <span className="d-none d-sm-inline">Account</span>
                        ...
                        >
                          <Link
                            ...
                            data-bs-toggle="tab"
                            data-toggle="tab"
                            className={`nav-link rounded-0 py-2 ${currentStep3 === 2 ? "active" : ""
                              }`}
                          >
                            <i className="bi bi-emoji-smile fs-18 align-middle me-1" />
                            <span className="d-none d-sm-inline">Profile</span>
                        ...
                        <li className="nav-item" data-target-form="#otherForm">
                          <Link
                            ...
                            data-bs-toggle="tab"
                            data-toggle="tab"
                            className={`nav-link rounded-0 py-2 ${currentStep3 === 3 ? "active" : ""
                              }`}
                          >
                            <i className="bi bi-check2-circle fs-18 align-middle me-1" />
                            <span className="d-none d-sm-inline">Finish</span>
