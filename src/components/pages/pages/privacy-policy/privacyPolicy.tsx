        ...
        <div className="content">
          ...
          <div className="card">
            <div className="card-body">
              <p>
                At   EMR, we value your privacy and are committed to
                protecting your personal data. This Privacy Policy explains how
                we collect, use, disclose, and safeguard your information when
                you access and use our   EMR Platform, including features
              ...
              <div className="mb-3">
                ...
                <ul className="unorder-list">
                  <li className="list-item">
                    <p>
                      Physicians, nurses, technicians, and other licensed
              ...
              <div className="mb-0">
                ...
                <p className="mb-0">
                  ...
                  use of the   EMR platform signifies your acceptance of any
                  updates.
                </p>
              </div>
            </div>
