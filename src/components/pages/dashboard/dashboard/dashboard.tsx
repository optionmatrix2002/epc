        ...
        <div className="content pb-0">
          ...
          <div className="row">
            <div className="col-xl-3 col-md-6">
              <Link
                href="/doctors"
                className="position-relative border card rounded-2 shadow-sm text-decoration-none"
              >
                <ImageWithBasePath
          ...
          <div className="row">
            ...
            <div className="col-xl-8">
              ...
              <div className="card shadow-sm flex-fill w-100">
                <div className="card-header d-flex align-items-center justify-content-between">
                  <h5 className="fw-bold mb-0">Popular Physicians</h5>
                  <div className="dropdown">
                    <Link
                      href="#"
                      className="btn btn-sm px-2 border shadow-sm btn-outline-white d-inline-flex align-items-center"
          ...
          <div className="row">
            ...
            <div className="col-xl-4 col-lg-6 d-flex">
              <div className="card shadow-sm flex-fill w-100">
                <div className="card-header d-flex align-items-center justify-content-between">
                  <h5 className="fw-bold mb-0">Physicians Schedule</h5>
                  <Link
                    href={all_routes.doctorschedule}
